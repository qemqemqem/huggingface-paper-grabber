#!/usr/bin/env python3
"""
Command-line interface for HuggingFace Paper Grabber (Updated for 2024 Website Structure)
...
from categorized_grabber_updated import CategorizedPaperGrabber
