#!/usr/bin/env python3
"""
HuggingFace Paper Grabber (Updated for 2024 Website Structure)
...
class HFPaperGrabber:
    ...
    def get_paper_details(self, paper_info):
        ...
        # Extract abstract - updated selector for 2024 website structure
        # Look for sections that might contain the abstract
        ...
        # Extract PDF link - common patterns
        pdf_link = None
